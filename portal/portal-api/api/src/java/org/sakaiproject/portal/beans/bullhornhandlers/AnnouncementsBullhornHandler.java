...
public class AnnouncementsBullhornHandler extends AbstractBullhornHandler {
    ...
    public List<String> getHandledEvents() {
        return Arrays.asList(AnnouncementService.SECURE_ANNC_ADD, AnnouncementService.EVENT_ANNC_UPDATE_AVAILABILITY, AnnouncementService.SECURE_ANNC_REMOVE_OWN, AnnouncementService.SECURE_ANNC_REMOVE_ANY,org.sakaiproject.announcement.api.AnnouncementService.EVENT_AVAILABLE_ANNC);
    }
