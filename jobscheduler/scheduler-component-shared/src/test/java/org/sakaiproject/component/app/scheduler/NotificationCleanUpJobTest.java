...
public class NotificationCleanUpJobTest {
    ...
    private Set<String> allowedTools = Set.of(ASSIGNMENT_TOOL_PREFIX, SAMIGO_TOOL_PREFIX, ANNOUNCEMENT_TOOL_PREFIX, CONTENT_TOOL_PREFIX);
    ...
    public void setUp() throws Exception {
        ...
        // return mocked job instance for NotificationCleanupJob
        ...
        setupServerConfigurationServiceMock(defaultThreshold, null, null, null, null);
    }
    ...
    public void execute_shouldRunQuartzJob() throws Exception {
        ...
        setupServerConfigurationServiceMock(10, null, null, null, null);
    ...
    public void shouldSkipJob_ifGlobalThresholdIsZero() throws JobExecutionException {
        setupServerConfigurationServiceMock(0, null, null, null, null);
    ...
    public void shouldSkipJob_ifToolThresholdsAreZero() throws JobExecutionException {
        setupServerConfigurationServiceMock(null, 0, 0, 0, 0);
        JobExecutionContext context = mock(JobExecutionContext.class);
    ...
    public void shouldSkipJob_ifToolThresholdsAreZeroAndGlobalIsSet()  throws JobExecutionException {
        setupServerConfigurationServiceMock(100, 0, 0, 0, 0);
        JobExecutionContext context = mock(JobExecutionContext.class);
    ...
    @Test
    public void shouldOnlyProcessNotificationforTool_ifNonZeroPositiveThresholdIsSet()  throws JobExecutionException {
        int userCount = 10;
        setUpRandomRepoState(10, userCount);
        int thresholdAnnouncement = 10;
        setupServerConfigurationServiceMock(null, 0, thresholdAnnouncement, 0, 0);
    ...
    private void setUpRandomRepoState(int threshold, int userCount) {
        ...
        for (int i = 0; i < userCount; i++) {
            ...
            countsByUserForTool.put("asn", randomLongOver2TimesTheThreshold(threshold));
            countsByUserForTool.put("sam", randomLongOver2TimesTheThreshold(threshold));
            countsByUserForTool.put("annc", randomLongOver2TimesTheThreshold(threshold));
            countsByUserForTool.put("content", randomLongOver2TimesTheThreshold(threshold));
    ...
    private void setupServerConfigurationServiceMock(Integer global, Integer samigo, Integer announcement, Integer assignment , Integer content) {
       ...
       when(serverConfigurationService.getInt(("notification.cleanup.threshold.per.tool." + ANNOUNCEMENT_TOOL_PREFIX), global)).thenReturn(announcement.intValue());
        ...
        if (content == null)  content = global;
        when(serverConfigurationService.getInt(("notification.cleanup.threshold.per.tool." + CONTENT_TOOL_PREFIX), global)).thenReturn(content.intValue());
    }
